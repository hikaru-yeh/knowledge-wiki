...
| ambiguous-bare-link | `wiki-pages/index/工具軟體-索引.md` | 12 | `Mac-Tool` | bare wikilink matches multiple targets: wiki-pages/工具軟體/Mac-Tool.md, raw/threads-saved/Mac-Tool.md |
| missing-target | `wiki-pages/index/健康生活-索引.md` | 31 | `Deleted-Health-Page` | wikilink target not found |
| stub-marker-mismatch | `wiki-pages/index/AI-工具-索引.md` | 48 | `Promoted-Page` | page status is wiki but index has stub marker |
| stub-marker-mismatch | `wiki-pages/index/工具軟體-索引.md` | 15 | `Still-A-Stub` | page status is stub but index has no stub marker |
| stub-marker-mismatch | `wiki-pages/index/旅遊美食-索引.md` | 22 | `Another-Mismatch` | page status is wiki but index has stub marker |
